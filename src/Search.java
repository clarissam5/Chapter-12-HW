...
public class Search {
    ...
    //search using array of cards and Card objects to print index where card appears
    ...
    //Binary search (iterative version). Declare low and high variables to represent the range
    //we are searching ;  initilly we search the entire array from 0 to length - 1
    ...
    //write method that takes low and high as parameters
    public static int binarySearch(Card[] cards, Card target,
                                   int low, int high) {
        System.out.println(low + ", " + high);
